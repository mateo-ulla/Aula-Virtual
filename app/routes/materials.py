...
from app.decorators import roles_required, enrolled_in_course_required
...
def manage_materials(curso_id):
    ...
    if form.validate_on_submit():
        try:
            ...
            flash(f'Error al subir el material: {str(e)}', 'danger')
            return redirect(url_for('materials.manage_materials', curso_id=curso.id))
...
def download_material(material_id):
    ...
    try:
        ...
        flash(f'Error al descargar material: {str(e)}', 'danger')
